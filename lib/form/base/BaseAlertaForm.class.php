...
/**
 * Alerta form base class.
 *
 * @method Alerta getObject() Returns the current form's model object
 *
 * @package    tesina_udc
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseAlertaForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorPropelUnique(array('model' => 'Alerta', 'column' => array('tipo_alerta')))
    );

    $this->widgetSchema->setNameFormat('alerta[%s]');
