...
/**
 * Base class that represents a row from the 'estado_persona' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseEstadoPersona extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'EstadoPersonaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EstadoPersonaPeer
     */
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[] = EstadoPersonaPeer::ESTADO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EstadoPersonaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EstadoPersona object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EstadoPersonaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EstadoPersonaQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEstadoPersona:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEstadoPersona:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseEstadoPersona:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseEstadoPersona:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                EstadoPersonaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `estado_persona` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EstadoPersonaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EstadoPersonaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
     ...
     * objects.
     *
     * @param      object $copyObj An object of EstadoPersona (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 EstadoPersona Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   EstadoPersonaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EstadoPersonaPeer();
        }
     ...
     * Otherwise if this EstadoPersona is new, it will return
     * an empty collection; or if this EstadoPersona has previously
     * been saved, it will retrieve related Personas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EstadoPersona.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Persona[] List of Persona objects
     */
    public function getPersonasJoinDireccionRelatedByDireccionPostalId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PersonaQuery::create(null, $criteria);
        $query->joinWith('DireccionRelatedByDireccionPostalId', $join_behavior);
     ...
     * @return PropelObjectCollection|Persona[] List of Persona objects
     */
    public function getPersonasJoinDireccionRelatedByDireccionRealId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PersonaQuery::create(null, $criteria);
        $query->joinWith('DireccionRelatedByDireccionRealId', $join_behavior);
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseEstadoPersona:' . $name))
		{
