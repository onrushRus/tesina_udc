...
/**
 * Base static class for performing query and update operations on the 'persona_fisica' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BasePersonaFisicaPeer {

    /** the default database name for this class */
    const DATABASE_NAME = 'propel';

    /** the table name for this class */
    const TABLE_NAME = 'persona_fisica';

    /** the related Propel class for this table */
    const OM_CLASS = 'PersonaFisica';
    ...
    const APELLIDO = 'persona_fisica.APELLIDO';

    /** the column name for the USUARIO field */
    const USUARIO = 'persona_fisica.USUARIO';

    /** the column name for the PASSWORD field */
    const PASSWORD = 'persona_fisica.PASSWORD';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of PersonaFisica objects.
     * This must be public so that other peer classes can access this when hydrating from JOIN
     * queries.
     * @var        array PersonaFisica[]
     */
     ...
     * @param      string $column The column name for current table. (i.e. PersonaFisicaPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(PersonaFisicaPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(PersonaFisicaPeer::TABLE_NAME);
		...
		{
		  call_user_func($sf_hook, 'BasePersonaFisicaPeer', $criteria, $con);
		}
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = PersonaFisicaPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return PersonaFisicaPeer::populateObjects(PersonaFisicaPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      PersonaFisica $obj A PersonaFisica object.
     ...
     *
     * @param      mixed $value A PersonaFisica object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof PersonaFisica) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or PersonaFisica object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return   PersonaFisica Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to persona_fisica
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = PersonaFisicaPeer::getOMClass();
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = PersonaFisicaPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = PersonaFisicaPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                PersonaFisicaPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (PersonaFisica object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = PersonaFisicaPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = PersonaFisicaPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + PersonaFisicaPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PersonaFisicaPeer::OM_CLASS;
            $obj = new $cls();
     ...
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of PersonaFisica objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = PersonaFisicaPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = PersonaFisicaPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    /**
     * Selects a collection of PersonaFisica objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
      $dbMap = Propel::getDatabaseMap(BasePersonaFisicaPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BasePersonaFisicaPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PersonaFisicaTableMap());
      }
    }
    ...
    {
        return PersonaFisicaPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a PersonaFisica or Criteria object.
     *
     * @param      mixed $values Criteria or PersonaFisica object containing data that is used to create the INSERT statement.
    ...
    /**
     * Performs an UPDATE on the database, given a PersonaFisica or Criteria object.
     *
     * @param      mixed $values Criteria or PersonaFisica object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        } else { // $values is PersonaFisica object
    ...
    /**
     * Deletes all rows from the persona_fisica table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(PersonaFisicaPeer::TABLE_NAME, $con, PersonaFisicaPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            PersonaFisicaPeer::clearInstancePool();
            PersonaFisicaPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a PersonaFisica or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or PersonaFisica object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof PersonaFisica) { // it's a model object
            // invalidate the cache for this single object
            PersonaFisicaPeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given PersonaFisica object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      PersonaFisica $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(PersonaFisicaPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(PersonaFisicaPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(PersonaFisicaPeer::DATABASE_NAME, PersonaFisicaPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = PersonaFisicaPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasePersonaFisicaPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
	
	  throw new LogicException(sprintf('Unrecognized function "%s"', $method));
	}

} // BasePersonaFisicaPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BasePersonaFisicaPeer::buildTableMap();
