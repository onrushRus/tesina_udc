 ...
 *
 * @method     DireccionQuery leftJoinPersonaRelatedByDireccionPostalId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonaRelatedByDireccionPostalId relation
 * @method     DireccionQuery rightJoinPersonaRelatedByDireccionPostalId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonaRelatedByDireccionPostalId relation
 * @method     DireccionQuery innerJoinPersonaRelatedByDireccionPostalId($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonaRelatedByDireccionPostalId relation
 *
 * @method     DireccionQuery leftJoinPersonaRelatedByDireccionRealId($relationAlias = null) Adds a LEFT JOIN clause to the query using the PersonaRelatedByDireccionRealId relation
 * @method     DireccionQuery rightJoinPersonaRelatedByDireccionRealId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the PersonaRelatedByDireccionRealId relation
 * @method     DireccionQuery innerJoinPersonaRelatedByDireccionRealId($relationAlias = null) Adds a INNER JOIN clause to the query using the PersonaRelatedByDireccionRealId relation
 *
...
abstract class BaseDireccionQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `ID_DIRECCION`, `LOCALIDAD_ID`, `CALLE`, `NUMERO`, `PISO`, `DEPARTAMENTO` FROM `direccion` WHERE `ID_DIRECCION` = :p0';
        try {
     ...
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByPersonaRelatedByDireccionPostalId($persona, $comparison = null)
    {
        if ($persona instanceof Persona) {
            return $this
                ->addUsingAlias(DireccionPeer::ID_DIRECCION, $persona->getDireccionPostalId(), $comparison);
        } elseif ($persona instanceof PropelObjectCollection) {
            return $this
                ->usePersonaRelatedByDireccionPostalIdQuery()
                ->filterByPrimaryKeys($persona->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPersonaRelatedByDireccionPostalId() only accepts arguments of type Persona or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PersonaRelatedByDireccionPostalId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return DireccionQuery The current query, for fluid interface
     */
    public function joinPersonaRelatedByDireccionPostalId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PersonaRelatedByDireccionPostalId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PersonaRelatedByDireccionPostalId');
        }
    ...
    /**
     * Use the PersonaRelatedByDireccionPostalId relation Persona object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function usePersonaRelatedByDireccionPostalIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPersonaRelatedByDireccionPostalId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PersonaRelatedByDireccionPostalId', 'PersonaQuery');
    }
     ...
     * @throws   PropelException - if the provided filter is invalid.
     */
    public function filterByPersonaRelatedByDireccionRealId($persona, $comparison = null)
    {
        if ($persona instanceof Persona) {
            return $this
                ->addUsingAlias(DireccionPeer::ID_DIRECCION, $persona->getDireccionRealId(), $comparison);
        } elseif ($persona instanceof PropelObjectCollection) {
            return $this
                ->usePersonaRelatedByDireccionRealIdQuery()
                ->filterByPrimaryKeys($persona->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByPersonaRelatedByDireccionRealId() only accepts arguments of type Persona or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the PersonaRelatedByDireccionRealId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return DireccionQuery The current query, for fluid interface
     */
    public function joinPersonaRelatedByDireccionRealId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('PersonaRelatedByDireccionRealId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'PersonaRelatedByDireccionRealId');
        }
    ...
    /**
     * Use the PersonaRelatedByDireccionRealId relation Persona object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   PersonaQuery A secondary query class using the current class as primary query
     */
    public function usePersonaRelatedByDireccionRealIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinPersonaRelatedByDireccionRealId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'PersonaRelatedByDireccionRealId', 'PersonaQuery');
    }
