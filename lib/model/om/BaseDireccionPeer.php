...
abstract class BaseDireccionPeer {
    ...
    /**
     * An identiy map to hold any loaded instances of Direccion objects.
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
		...
		{
		  call_user_func($sf_hook, 'BaseDireccionPeer', $criteria, $con);
		}
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Direccion) {
                $key = (string) $value->getIdDireccion();
    ...
    /**
     * Returns the number of rows matching criteria, joining the related TipoDireccion table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinTipoDireccion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Direccion objects pre-filled with their TipoDireccion objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Direccion objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinTipoDireccion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = TipoDireccionPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = TipoDireccionPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    TipoDireccionPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Direccion) to $obj2 (TipoDireccion)
                $obj2->addDireccion($obj1);
    ...
    /**
     * Selects a collection of Direccion objects pre-filled with their Localidad objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Direccion objects.
    ...
    public static function doSelectJoinLocalidad(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Direccion) to $obj2 (Localidad)
                $obj2->addDireccion($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined TipoDireccion rows

            $key3 = TipoDireccionPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = TipoDireccionPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    TipoDireccionPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Direccion) to the collection in $obj3 (TipoDireccion)
                $obj3->addDireccion($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Direccion) to the collection in $obj4 (Localidad)
                $obj4->addDireccion($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptTipoDireccion(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptPersona(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        TipoDireccionPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + TipoDireccionPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = DireccionPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = TipoDireccionPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = TipoDireccionPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Direccion) to the collection in $obj2 (TipoDireccion)
                $obj2->addDireccion($obj1);
                ...
                // Add the $obj1 (Direccion) to the collection in $obj3 (Localidad)
                $obj3->addDireccion($obj1);
    ...
    /**
     * Selects a collection of Direccion objects pre-filled with all related objects except TipoDireccion.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptTipoDireccion(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Selects a collection of Direccion objects pre-filled with all related objects except Localidad.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(DireccionPeer::ID_DIRECCION) && $criteria->keyContainsValue(DireccionPeer::ID_DIRECCION) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(DireccionPeer::ID_DIRECCION);
            $value = $criteria->remove(DireccionPeer::ID_DIRECCION);
            if ($value) {
                $selectCriteria->add(DireccionPeer::ID_DIRECCION, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(DireccionPeer::ID_DIRECCION, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria->add(DireccionPeer::ID_DIRECCION, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(DireccionPeer::DATABASE_NAME);
            $criteria->add(DireccionPeer::ID_DIRECCION, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseDireccionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
