...
abstract class BaseProvincia extends BaseObject 
{
    ...
    /**
     * The value for the nombre_provincia field.
     * @var        string
     */
    ...
    /**
     * Get the [nombre_provincia] column value.
     * 
     * @return   string
     */
    ...
    /**
     * Set the value of [nombre_provincia] column.
     * 
     * @param      string $v new value
     * @return   Provincia The current object (for fluent API support)
     */
    public function setNombreProvincia($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->nombre_provincia !== $v) {
            $this->nombre_provincia = $v;
            $this->modifiedColumns[] = ProvinciaPeer::NOMBRE_PROVINCIA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->nombre_provincia = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProvinciaPeer::NOMBRE_PROVINCIA)) {
            $modifiedColumns[':p' . $index++]  = '`NOMBRE_PROVINCIA`';
        }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getNombreProvincia(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setNombreProvincia($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProvinciaPeer::NOMBRE_PROVINCIA)) $criteria->add(ProvinciaPeer::NOMBRE_PROVINCIA, $this->nombre_provincia);
    ...
    {
        $copyObj->setNombreProvincia($this->getNombreProvincia());
