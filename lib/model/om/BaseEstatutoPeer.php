...
/**
 * Base static class for performing query and update operations on the 'estatuto' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseEstatutoPeer {

    /** the default database name for this class */
    const DATABASE_NAME = 'propel';

    /** the table name for this class */
    const TABLE_NAME = 'estatuto';

    /** the related Propel class for this table */
    const OM_CLASS = 'Estatuto';
    ...
    /**
     * An identiy map to hold any loaded instances of Estatuto objects.
     ...
     * @param      string $column The column name for current table. (i.e. EstatutoPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(EstatutoPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(EstatutoPeer::TABLE_NAME);
        ...
        if (!$criteria->hasSelectClause()) {
            EstatutoPeer::addSelectColumns($criteria);
        }
		...
		{
		  call_user_func($sf_hook, 'BaseEstatutoPeer', $criteria, $con);
		}
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = EstatutoPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return EstatutoPeer::populateObjects(EstatutoPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      Estatuto $obj A Estatuto object.
     ...
     *
     * @param      mixed $value A Estatuto object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Estatuto) {
                $key = (string) $value->getIdEstatuto();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Estatuto object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return   Estatuto Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to estatuto
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = EstatutoPeer::getOMClass();
        // populate the object(s)
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = EstatutoPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = EstatutoPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                EstatutoPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Estatuto object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = EstatutoPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = EstatutoPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + EstatutoPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = EstatutoPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinPersonaJuridica(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(EstatutoPeer::PERSONA_JURIDICA_ID, PersonaJuridicaPeer::ID_PERSONA_JURIDICA, $join_behavior);
    ...
    /**
     * Selects a collection of Estatuto objects pre-filled with their PersonaJuridica objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Estatuto objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinPersonaJuridica(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EstatutoPeer::addSelectColumns($criteria);
        $startcol = EstatutoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = EstatutoPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = EstatutoPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                EstatutoPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Estatuto) to $obj2 (PersonaJuridica)
                $obj2->addEstatuto($obj1);
    ...
    /**
     * Selects a collection of Estatuto objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        EstatutoPeer::addSelectColumns($criteria);
        $startcol2 = EstatutoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Estatuto) to the collection in $obj2 (PersonaJuridica)
                $obj2->addEstatuto($obj1);
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseEstatutoPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseEstatutoPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new EstatutoTableMap());
      }
    }
    ...
    {
        return EstatutoPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Estatuto or Criteria object.
     *
     * @param      mixed $values Criteria or Estatuto object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from Estatuto object
        }

        if ($criteria->containsKey(EstatutoPeer::ID_ESTATUTO) && $criteria->keyContainsValue(EstatutoPeer::ID_ESTATUTO) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Estatuto or Criteria object.
     *
     * @param      mixed $values Criteria or Estatuto object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(EstatutoPeer::ID_ESTATUTO);
            $value = $criteria->remove(EstatutoPeer::ID_ESTATUTO);
            if ($value) {
                $selectCriteria->add(EstatutoPeer::ID_ESTATUTO, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(EstatutoPeer::TABLE_NAME);
            }

        } else { // $values is Estatuto object
    ...
    /**
     * Deletes all rows from the estatuto table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(EstatutoPeer::TABLE_NAME, $con, EstatutoPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            EstatutoPeer::clearInstancePool();
            EstatutoPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a Estatuto or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or Estatuto object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Estatuto) { // it's a model object
            // invalidate the cache for this single object
            EstatutoPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(self::DATABASE_NAME);
            $criteria->add(EstatutoPeer::ID_ESTATUTO, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                EstatutoPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given Estatuto object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      Estatuto $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(EstatutoPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(EstatutoPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(EstatutoPeer::DATABASE_NAME, EstatutoPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = EstatutoPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria->add(EstatutoPeer::ID_ESTATUTO, $pk);

        $v = EstatutoPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(EstatutoPeer::DATABASE_NAME);
            $criteria->add(EstatutoPeer::ID_ESTATUTO, $pks, Criteria::IN);
            $objs = EstatutoPeer::doSelect($criteria, $con);
        }
	...
	{
	  return array(array('persona_juridica_id'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseEstatutoPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
...
//
BaseEstatutoPeer::buildTableMap();
