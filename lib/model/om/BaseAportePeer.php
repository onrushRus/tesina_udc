...
/**
 * Base static class for performing query and update operations on the 'aporte' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseAportePeer {

    /** the default database name for this class */
    const DATABASE_NAME = 'propel';

    /** the table name for this class */
    const TABLE_NAME = 'aporte';

    /** the related Propel class for this table */
    const OM_CLASS = 'Aporte';
    ...
    /** the column name for the MONTO_APORTE field */
    const MONTO_APORTE = 'aporte.MONTO_APORTE';

    /** the column name for the NUMERO_EXPEDIENTE field */
    const NUMERO_EXPEDIENTE = 'aporte.NUMERO_EXPEDIENTE';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Aporte objects.
     ...
     * @param      string $column The column name for current table. (i.e. AportePeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(AportePeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = AportePeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return AportePeer::populateObjects(AportePeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param      Aporte $obj A Aporte object.
     ...
     *
     * @param      mixed $value A Aporte object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Aporte) {
                $key = (string) $value->getIdAporte();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Aporte object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }
     ...
     * @return   Aporte Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
    ...
    /**
     * Method to invalidate the instance pool of all tables related to aporte
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = AportePeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = AportePeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                AportePeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (Aporte object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = AportePeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = AportePeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + AportePeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = AportePeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doSelectJoinPersonaJuridica(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Aporte) to $obj2 (PersonaJuridica)
                $obj2->addAporte($obj1);
    ...
    /**
     * Selects a collection of Aporte objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseAportePeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseAportePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new AporteTableMap());
      }
    }
    ...
    {
        return AportePeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Aporte or Criteria object.
     *
     * @param      mixed $values Criteria or Aporte object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria = $values->buildCriteria(); // build Criteria from Aporte object
        }

        if ($criteria->containsKey(AportePeer::ID_APORTE) && $criteria->keyContainsValue(AportePeer::ID_APORTE) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Aporte or Criteria object.
     *
     * @param      mixed $values Criteria or Aporte object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(AportePeer::ID_APORTE);
            $value = $criteria->remove(AportePeer::ID_APORTE);
            if ($value) {
                $selectCriteria->add(AportePeer::ID_APORTE, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(AportePeer::TABLE_NAME);
            }

        } else { // $values is Aporte object
    ...
    /**
     * Deletes all rows from the aporte table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(AportePeer::TABLE_NAME, $con, AportePeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            AportePeer::clearInstancePool();
            AportePeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a Aporte or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or Aporte object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof Aporte) { // it's a model object
            // invalidate the cache for this single object
            AportePeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(self::DATABASE_NAME);
            $criteria->add(AportePeer::ID_APORTE, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                AportePeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given Aporte object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param      Aporte $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(AportePeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(AportePeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(AportePeer::DATABASE_NAME, AportePeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = AportePeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria->add(AportePeer::ID_APORTE, $pk);

        $v = AportePeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(AportePeer::DATABASE_NAME);
            $criteria->add(AportePeer::ID_APORTE, $pks, Criteria::IN);
            $objs = AportePeer::doSelect($criteria, $con);
        }
	...
	{
	  return array(array('numero_expediente'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseAportePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
