...
abstract class BaseActividadPeer {
    ...
    const ACTIVIDAD = 'actividad.ACTIVIDAD';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdActividad', 'Actividad', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idActividad', 'actividad', ),
        BasePeer::TYPE_COLNAME => array (self::ID_ACTIVIDAD, self::ACTIVIDAD, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACTIVIDAD', 'ACTIVIDAD', ),
        BasePeer::TYPE_FIELDNAME => array ('id_actividad', 'actividad', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdActividad' => 0, 'Actividad' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idActividad' => 0, 'actividad' => 1, ),
        BasePeer::TYPE_COLNAME => array (self::ID_ACTIVIDAD => 0, self::ACTIVIDAD => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_ACTIVIDAD' => 0, 'ACTIVIDAD' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id_actividad' => 0, 'actividad' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ActividadPeer::ID_ACTIVIDAD);
            $criteria->addSelectColumn(ActividadPeer::ACTIVIDAD);
        } else {
     ...
     *
     * @param      Actividad $obj A Actividad object.
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Actividad) {
                $key = (string) $value->getIdActividad();
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ActividadPeer::ID_ACTIVIDAD) && $criteria->keyContainsValue(ActividadPeer::ID_ACTIVIDAD) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ActividadPeer::ID_ACTIVIDAD);
            $value = $criteria->remove(ActividadPeer::ID_ACTIVIDAD);
            if ($value) {
                $selectCriteria->add(ActividadPeer::ID_ACTIVIDAD, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ActividadPeer::ID_ACTIVIDAD, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ActividadPersJuridicaPeer::ACTIVIDAD_ID, $obj->getIdActividad());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria->add(ActividadPeer::ID_ACTIVIDAD, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ActividadPeer::DATABASE_NAME);
            $criteria->add(ActividadPeer::ID_ACTIVIDAD, $pks, Criteria::IN);
