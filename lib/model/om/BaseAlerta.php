...
/**
 * Base class that represents a row from the 'alerta' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseAlerta extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'AlertaPeer';
    ...
    /**
     * Initializes internal state of BaseAlerta object.
     * @see        applyDefaults()
     */
     ...
     * @return   Alerta The current object (for fluent API support)
     */
    public function setIdTipoAlerta($v)
    {
        ...
        if ($this->id_tipo_alerta !== $v) {
            ...
            $this->modifiedColumns[] = AlertaPeer::ID_TIPO_ALERTA;
        }
    ...
    public function setTipoAlerta($v)
    {
        ...
        if ($this->tipo_alerta !== $v) {
            $this->tipo_alerta = $v;
            $this->modifiedColumns[] = AlertaPeer::TIPO_ALERTA;
        }
    ...
    public function setDiasParaAviso($v)
    {
        ...
        if ($this->dias_para_aviso !== $v) {
            ...
            $this->modifiedColumns[] = AlertaPeer::DIAS_PARA_AVISO;
        }
    ...
    public function setCuerpoMensaje($v)
    {
        ...
        if ($this->cuerpo_mensaje !== $v) {
            ...
            $this->modifiedColumns[] = AlertaPeer::CUERPO_MENSAJE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = AlertaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Alerta object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AlertaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AlertaQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlerta:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlerta:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseAlerta:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseAlerta:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                AlertaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AlertaPeer::ID_TIPO_ALERTA)) {
            $modifiedColumns[':p' . $index++]  = '`ID_TIPO_ALERTA`';
        }
        if ($this->isColumnModified(AlertaPeer::TIPO_ALERTA)) {
            $modifiedColumns[':p' . $index++]  = '`TIPO_ALERTA`';
        }
        if ($this->isColumnModified(AlertaPeer::DIAS_PARA_AVISO)) {
            $modifiedColumns[':p' . $index++]  = '`DIAS_PARA_AVISO`';
        }
        if ($this->isColumnModified(AlertaPeer::CUERPO_MENSAJE)) {
            $modifiedColumns[':p' . $index++]  = '`CUERPO_MENSAJE`';
        }

        $sql = sprintf(
            'INSERT INTO `alerta` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AlertaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AlertaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Alerta'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Alerta'][$this->getPrimaryKey()] = true;
        $keys = AlertaPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlertaPeer::ID_TIPO_ALERTA)) $criteria->add(AlertaPeer::ID_TIPO_ALERTA, $this->id_tipo_alerta);
        if ($this->isColumnModified(AlertaPeer::TIPO_ALERTA)) $criteria->add(AlertaPeer::TIPO_ALERTA, $this->tipo_alerta);
        if ($this->isColumnModified(AlertaPeer::DIAS_PARA_AVISO)) $criteria->add(AlertaPeer::DIAS_PARA_AVISO, $this->dias_para_aviso);
        if ($this->isColumnModified(AlertaPeer::CUERPO_MENSAJE)) $criteria->add(AlertaPeer::CUERPO_MENSAJE, $this->cuerpo_mensaje);
    ...
    {
        $criteria = new Criteria(AlertaPeer::DATABASE_NAME);
        $criteria->add(AlertaPeer::ID_TIPO_ALERTA, $this->id_tipo_alerta);
     ...
     * objects.
     *
     * @param      object $copyObj An object of Alerta (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 Alerta Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Alerta is new, it will return
    ...
    public function setEnteAlertas(PropelCollection $enteAlertas, PropelPDO $con = null)
    {
        ...
        foreach ($this->enteAlertasScheduledForDeletion as $enteAlertaRemoved) {
            $enteAlertaRemoved->setAlerta(null);
        }
     ...
     * Otherwise if this Alerta is new, it will return
     * an empty collection; or if this Alerta has previously
     * been saved, it will retrieve related EnteAlertas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Alerta.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(AlertaPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseAlerta:' . $name))
		{
