...
/**
 * Base class that represents a row from the 'situacion_persona_juridica' table.
 *
 * 
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseSituacionPersonaJuridica extends BaseObject 
{

    /**
     * Peer class name
     */
    const PEER = 'SituacionPersonaJuridicaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        SituacionPersonaJuridicaPeer
     */
    ...
    /**
     * The value for the id_situacion_pers_juridica field.
     * @var        int
     */
    protected $id_situacion_pers_juridica;

    /**
     * The value for the situacion field.
     * @var        string
     */
    protected $situacion;
    ...
    /**
     * Get the [id_situacion_pers_juridica] column value.
     * 
     * @return   int
     */
    public function getIdSituacionPersJuridica()
    {

        return $this->id_situacion_pers_juridica;
    }

    /**
     * Get the [situacion] column value.
     * 
     * @return   string
     */
    ...
    /**
     * Set the value of [id_situacion_pers_juridica] column.
     * 
     * @param      int $v new value
     * @return   SituacionPersonaJuridica The current object (for fluent API support)
     */
    public function setIdSituacionPersJuridica($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_situacion_pers_juridica !== $v) {
            $this->id_situacion_pers_juridica = $v;
            $this->modifiedColumns[] = SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA;
        }


        return $this;
    } // setIdSituacionPersJuridica()

    /**
     * Set the value of [situacion] column.
     * 
    ...
    public function setSituacion($v)
    {
        ...
        if ($this->situacion !== $v) {
            $this->situacion = $v;
            $this->modifiedColumns[] = SituacionPersonaJuridicaPeer::SITUACION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_situacion_pers_juridica = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->situacion = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = SituacionPersonaJuridicaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SituacionPersonaJuridica object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SituacionPersonaJuridicaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SituacionPersonaJuridicaQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSituacionPersonaJuridica:delete:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSituacionPersonaJuridica:delete:post') as $callable)
				{
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSituacionPersonaJuridica:save:pre') as $callable)
			{
            ...
            if ($ret) {
                ...
                $this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSituacionPersonaJuridica:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

                SituacionPersonaJuridicaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA;
        if (null !== $this->id_situacion_pers_juridica) {
        ...
        if ($this->isColumnModified(SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA)) {
            $modifiedColumns[':p' . $index++]  = '`ID_SITUACION_PERS_JURIDICA`';
        }
        if ($this->isColumnModified(SituacionPersonaJuridicaPeer::SITUACION)) {
            $modifiedColumns[':p' . $index++]  = '`SITUACION`';
        }

        $sql = sprintf(
            'INSERT INTO `situacion_persona_juridica` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`ID_SITUACION_PERS_JURIDICA`':						
						$stmt->bindValue($identifier, $this->id_situacion_pers_juridica, PDO::PARAM_INT);
                        break;
                    case '`SITUACION`':						
						$stmt->bindValue($identifier, $this->situacion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
        ...
        $this->setIdSituacionPersJuridica($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SituacionPersonaJuridicaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SituacionPersonaJuridicaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdSituacionPersJuridica();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['SituacionPersonaJuridica'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SituacionPersonaJuridica'][$this->getPrimaryKey()] = true;
        $keys = SituacionPersonaJuridicaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdSituacionPersJuridica(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdSituacionPersJuridica($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdSituacionPersJuridica($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA)) $criteria->add(SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA, $this->id_situacion_pers_juridica);
        if ($this->isColumnModified(SituacionPersonaJuridicaPeer::SITUACION)) $criteria->add(SituacionPersonaJuridicaPeer::SITUACION, $this->situacion);
    ...
    {
        $criteria = new Criteria(SituacionPersonaJuridicaPeer::DATABASE_NAME);
        $criteria->add(SituacionPersonaJuridicaPeer::ID_SITUACION_PERS_JURIDICA, $this->id_situacion_pers_juridica);
    ...
    /**
     * Generic method to set the primary key (id_situacion_pers_juridica column).
     *
    ...
    {
        $this->setIdSituacionPersJuridica($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdSituacionPersJuridica();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of SituacionPersonaJuridica (or compatible) type.
    ...
    {
        $copyObj->setSituacion($this->getSituacion());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdSituacionPersJuridica(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 SituacionPersonaJuridica Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return   SituacionPersonaJuridicaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SituacionPersonaJuridicaPeer();
        }
     ...
     * If this SituacionPersonaJuridica is new, it will return
        ...
        if (null === $this->collPersonaJuridicas || null !== $criteria) {
            if ($this->isNew() && null === $this->collPersonaJuridicas) {
                ...
                $collPersonaJuridicas = PersonaJuridicaQuery::create(null, $criteria)
                    ->filterBySituacionPersonaJuridica($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setPersonaJuridicas(PropelCollection $personaJuridicas, PropelPDO $con = null)
    {
        ...
        foreach ($this->personaJuridicasScheduledForDeletion as $personaJuridicaRemoved) {
            $personaJuridicaRemoved->setSituacionPersonaJuridica(null);
        }
    ...
    protected function doAddPersonaJuridica($personaJuridica)
    {
        ...
        $personaJuridica->setSituacionPersonaJuridica($this);
    }
    ...
    public function removePersonaJuridica($personaJuridica)
    {
        if ($this->getPersonaJuridicas()->contains($personaJuridica)) {
            ...
            $personaJuridica->setSituacionPersonaJuridica(null);
        }
    }
     ...
     * Otherwise if this SituacionPersonaJuridica is new, it will return
     * an empty collection; or if this SituacionPersonaJuridica has previously
     * been saved, it will retrieve related PersonaJuridicas from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SituacionPersonaJuridica.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      PropelPDO $con optional connection object
    ...
    {
        $this->id_situacion_pers_juridica = null;
        $this->situacion = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    public function __call($name, $params)
    {
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseSituacionPersonaJuridica:' . $name))
		{
