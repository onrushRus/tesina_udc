...
class ProvinciaTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('NOMBRE_PROVINCIA', 'NombreProvincia', 'VARCHAR', true, 30, null);
        $this->getColumn('NOMBRE_PROVINCIA', false)->setPrimaryString(true);
        // validators
    } // initialize()
    ...
    {
        $this->addRelation('Localidad', 'Localidad', RelationMap::ONE_TO_MANY, array('id_provincia' => 'provincia_id', ), 'CASCADE', 'CASCADE', 'Localidads');
    } // buildRelations()
