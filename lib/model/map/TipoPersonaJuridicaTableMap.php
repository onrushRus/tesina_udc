...
class TipoPersonaJuridicaTableMap extends TableMap
{
    ...
    {
        $this->addRelation('PersonaJuridica', 'PersonaJuridica', RelationMap::ONE_TO_MANY, array('id_tipo_persona_juridica' => 'tipo_pers_juridica_id', ), null, null, 'PersonaJuridicas');
    } // buildRelations()
