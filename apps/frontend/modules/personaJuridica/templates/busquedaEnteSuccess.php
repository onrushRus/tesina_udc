...
<fieldset>
    <form class="well form-search span5" action="<?php echo url_for('personaJuridica/busquedaEnte') ?>" method="POST">
       ...
       <input class="search-query" type="text" placeholder="Nombre o letras Parciales">
       <hr>
...
<?php if($var_post):?>
    <?php if(sizeof($ListaEntes)==0):?>
        <h1>No se encontro un joraca!</h1>
    <?php else: ?>
