...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <a class="btn btn-warning btn-mini" href="<?php echo url_for('actividad/edit?actividad_id='.$ActividadPersJuridica->getActividadId()) ?>"><i class="icon-pencil icon-white"></i>Modificar</a>
          <?php echo link_to('<i class="icon-trash icon-white"></i>Eliminar', 'actividad/delete?actividad_id='.$ActividadPersJuridica->getActividadId(), array('method' => 'delete', 'confirm' => 'Esta seguro de eliminar la combinación Actividad-Persona Juridica?', 'class'=>"btn btn-danger btn-mini")) ?>
      </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
...
<!--  <a class="btn btn-info" href="<?php // echo url_for('actividadPersJuridica/new') ?>">Nueva Actividad-Pers. Juridica</a> -->
