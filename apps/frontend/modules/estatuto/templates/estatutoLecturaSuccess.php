...
<?php if($sf_user->isAuthenticated()):?>
    <a class="btn btn-success" href="<?php echo url_for('estatuto/index?ente='.$Estatuto->getPersonaJuridicaId()) ?>"><i class="icon-arrow-left icon-white"></i>Volver al Estatuto</a>
<?php endif;?>